...
public:
	...
	int quickSort(bool show_iterations, bool count_access); //quick call
	void quickSort(const int& floor, const int& ceiling, bool show_iterations, int& counter); //quick sorting
	int partition(const int& floor, const int& ceiling, int& counter);
};